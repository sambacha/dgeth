...
fn c_str_to_string(string: *mut ::std::os::raw::c_char) -> String {
    ...
    // @see {@link https://doc.rust-lang.org/std/ffi/struct.CString.html#method.from_raw}
    unsafe { CString::from_raw(string).into_string().unwrap() }
}


// @dev this function is broken because cstr gets disposed before the *char string can be used.
